...
Initial release of Codex Token Widget.

## Highlights

- Portable native Windows executable.
- Always-on-top rounded desktop widget.
...
Download `CodexTokenWidgetPortable.exe` from this release.
